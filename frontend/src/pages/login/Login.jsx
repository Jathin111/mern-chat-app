...
import useIntoo from '../../hooks/useIntoo';
      ...
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form onSubmit={handleSubmit} >
            <div>
                ...
                <input type='text' placeholder='Enter username' className='w-full input input-boarded hover:input-error h-10'
                  value={username}
            ...
            <div>
                <button className="btn btn-block btn-sm mt-2 btn-error hover:btn-primary"
                  disabled={loading}
